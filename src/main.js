...
async function main() {
	...
	//     "http://127.0.0.1:5501/splat/model/model",
	// );
	// const url = "./model/model.splat"
	const url = ""
...
let progressTextDom = document.getElementById("progress-text");
...
const fetchSetFile = async (url) => {
	...
	xhr.addEventListener('load', function () {
		if (xhr.status === 200) {
			...
			console.log('Temporary file URL:', octreeFileUrl);
			loadScene()
